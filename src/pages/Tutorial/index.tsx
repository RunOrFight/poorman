...
const Index = () => {
  ...
  const gameBoardText = [
    { text: 'Player\'s name and health' },
    { text: 'Number of energy blocks' },
    { text: 'Card holder' },
    { text: 'Cards in hand' },
    { text: 'Opponent\'s cards in hand' },
    { text: 'End turn button' },
    { text: 'Fields for placing cards' },
  ];
    ...
    <div className={styled.wrapper}>
        ...
        <div className={styled.cardLevelContainer}>
          ...
          <div className={styled.levelList}>
            {levels.map((level, index) => {
              return (
                <div className={styled.levelItem} key={index}>
                  <img
                    ...
                    height={level.height}
                  />
                  <p className={styled.levelText}>{level.level}</p>
                  <p className={styled.text}>{level.name}</p>
                </div>
              );
            })}
          </div>
      ...
      <section>
        <div className={styled.cardClassContainer}>
          ...
          <div className={styled.cardClassList}>
            <div className={clsx(styled.cardClassItem, styled.cardClassItem__red)}>
              <div className={clsx(styled.classText, styled.classText__red)}>
                <p className={styled.text__red}>Red warrior</p>
                <p>forward</p>
              </div>
              <img
            ...
            <div className={clsx(styled.cardClassItem, styled.cardClassItem__blue)}>
              <div className={clsx(styled.classText, styled.classText__blue)}>
                <p className={styled.text__blue}>Blue archer</p>
                <p>forward and to the left</p>
              </div>
              <img
                className={clsx(styled.cardClassImg, styled.cardClassImg__blue)}
                src='/src/assets/tutorial/class_blue_1.png'
                alt='class_blue'
                width='250'
                height='312'
              />
            </div>
            <div className={clsx(styled.cardClassItem, styled.cardClassItem__green)}>
              <div className={clsx(styled.classText, styled.classText__green)}>
                <p className={styled.text__green}>Green shooter</p>
                <p>forward and to the right</p>
              </div>
              <img
                className={styled.cardClassImg}
                src='/src/assets/tutorial/class_green.png'
                alt='class_green'
                width='250'
                height='312'
              />
            </div>
            <div className={clsx(styled.cardClassItem, styled.cardClassItem__yellow)}>
              <div className={clsx(styled.classText, styled.classText__yellow)}>
                <p className={styled.text__yellow}>Yellow electric</p>
                <p>all three directions</p>
              </div>
              <img
                className={styled.cardClassImg}
                src='/src/assets/tutorial/class_yellow.png'
                alt='class_yellow'
                width='250'
                height='312'
              />
        ...
        <div className={styled.gameBoardContainer}>
          <div className={styled.gameBoardDescription}>
            ...
            <ul className={styled.gameBoardList}>
              {gameBoardText.map((elem, index) => {
                return (
                  <li className={styled.dot} key={index}>
                    {elem.text}
                  </li>
                );
              })}
      ...
      <section>
        <div className={styled.deckCardsContainer}>
          ...
          <div className={clsx(styled.deckCardList)}>
